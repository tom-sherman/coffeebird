...
describe('concept :: dictionary', function () {
  it('should parse valid dictionaries', function () {
    const validDictionaries = [
      ...
      [ '(type = string, behaviour = mutuallyExclusive)', { behaviour: 'mutuallyExclusive', type: 'string' } ],
      [ '(behaviour = mutuallyExclusive, type = string)', { behaviour: 'mutuallyExclusive', type: 'string' } ]
    ]
